 ...
 * @des 2018/12/18
 */
public class NavigationTitleEntity extends AbstractExpandableItem<NavigationArticlesEntity> implements MultiItemEntity {
    ...
    private int cid;
    private String name;
    private List<NavigationArticlesEntity> articles;
    ...
    public List<NavigationArticlesEntity> getArticles() {
        return articles;
    }

    public void setArticles(List<NavigationArticlesEntity> articles) {
